...
CHANNELS = [
    ...
    ("UCTA3AFI43NQ5Y9e9pzLZ2-Q", "hanako", "ハナコ", "trio", "conte", 500),
    ...
    ("UClttgkLnnGDILHNrSkY5A-w", "diamond", "ダイヤモンド", "combi", "conte", 500),
    ...
    ("UCJcyQ-N0sbvwjYpDNXP9tsw", "non-style", "NON STYLE", "combi", "manzai", 500),
    ("UCw2AIP_0OmgYqgAJU1jOH-g", "zophy", "ゾフィー", "combi", "conte", 100),
    ("UCCBz0umWMLaxtYxx8fMJOKw", "rice", "ライス", "combi", "conte", 300),
    ("UCsvQg7ihb2U10RBNNKK6ZPw", "yarenz", "ヤーレンズ", "combi", "conte", 300),
    ("UCdDjnBiXXxnIFT8WBKfm5jg", "sandal", "さんだる", "combi", "conte", 150),
    ("UCbJFVj5Zp7NVzOxAj75F7GQ", "kagaya", "かが屋", "combi", "conte", 300),
    ("UCDCHc4fuc8VydqyAgU-1ibA", "milk-boy", "ミルクボーイ", "combi", "manzai", 100),
    ("UCtw4BTDOwGkm0S0dlUglIBA", "ujikoji", "U字工事", "combi", "manzai", 350),
    ("UCpCesuCH4UxIcy65gSrC0Pw", "chocolate-planet", "チョコレートプラネット", "combi", "conte", 500),
    ("UC5TMOBmBuHYW1fBrKkrahCg", "nichou-kenjuu", "2丁拳銃", "combi", "conte", 100),
    ("UCFoQiWJ4Hovwb_xbII6f3Tw", "oshierus", "オシエルズ", "combi", "conte", 500),
    ("UCaurf0SwiLnLyYHiTiz-lKQ", "shizuru", "しずる", "combi", "conte", 250),
    ("UCMdLfSBEmAHXfjzG8nNwzxA", "kuuki-kaidan", "空気階段", "combi", "conte", 100),
]
